...
const MensCard = ({ mensProduct }) => {
    const { image, name, resell_price, buying_price, condition } = mensProduct;
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <div className="card-actions">
                            <label onClick={() => setBookProduct(mensProduct)} htmlFor="confirmation-modal" className="btn btn-primary">Book</label>
                        </div>
                    </div>
                </div>
            </div>
